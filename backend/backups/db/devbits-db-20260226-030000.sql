...
\restrict nJGpB5uSaQ5fCmjJfoGSoRiAXQCJU5J1JZgY5TlSg4ValCxlsLWEM8UKNr4haNs
...
9	\N	2	LetΓÇÖs go it is out!	[]	0	2026-02-26 07:42:09.638077
3	\N	12	Very cool	[]	2	2026-02-25 04:22:50.328314
6	\N	12	# **_I guess iΓÇÖm just better_**	[]	0	2026-02-25 14:37:45.700912
5	\N	2	Devbits doesnΓÇÖt have this yet :(	[]	1	2026-02-25 12:14:33.85307
7	\N	2	> [!IMPORTANT]\n>***WOW***	[]	0	2026-02-25 15:29:55.813755
\.
...
100	2	11	hello	2026-02-25 00:40:33.340134	\N
101	11	2	heyo	2026-02-25 00:41:12.631377	\N
102	2	12	Heyyyyyyyyy	2026-02-25 03:01:09.747674	\N
...
9	> [!CAUTION]\n> please do not upload media to stream byte or comment. It will break your app.	[]	1	2026-02-26 07:39:18.693523	2	0
...
SELECT pg_catalog.setval('public.userpushtokens_id_seq', 117, true);
...
--
-- Name: idx_comments_creation_date; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_comments_creation_date ON public.comments USING btree (creation_date DESC);
...
--
-- Name: idx_directmessages_recipient_created; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_directmessages_recipient_created ON public.directmessages USING btree (recipient_id, creation_date DESC);
...
--
-- Name: idx_posts_creation_date; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_posts_creation_date ON public.posts USING btree (creation_date DESC);
...
--
-- Name: idx_postsaves_post_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_postsaves_post_id ON public.postsaves USING btree (post_id);


--
-- Name: idx_postsaves_user_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_postsaves_user_id ON public.postsaves USING btree (user_id);


--
-- Name: idx_projectbuilders_user_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_projectbuilders_user_id ON public.projectbuilders USING btree (user_id);
...
--
-- Name: idx_projectfollows_user_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_projectfollows_user_id ON public.projectfollows USING btree (user_id);
...
--
-- Name: idx_projects_creation_date; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_projects_creation_date ON public.projects USING btree (creation_date DESC);
...
\unrestrict nJGpB5uSaQ5fCmjJfoGSoRiAXQCJU5J1JZgY5TlSg4ValCxlsLWEM8UKNr4haNs
